...
public class EliminarCursoServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet EliminarCursoServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet EliminarCursoServlet at " + request.getContextPath() + "</h1>");
            iCursoDao xp = new CursoDaoSQL();
            int idxp = Integer.parseInt(request.getParameter("idCurso"));
                if(xp.borrarCursos(idxp)){

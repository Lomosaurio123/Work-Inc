 ...
 * @author Hp
 */
@WebServlet(name = "ConsultaUsuarioCurriculum", urlPatterns = {"/ConsultaUsuarioCurriculum"})
public class ConsultaUsuarioCurriculum extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ConsultaUsuarioCurriculum</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ConsultaUsuarioCurriculum at " + request.getContextPath() + "</h1>");
            try{  

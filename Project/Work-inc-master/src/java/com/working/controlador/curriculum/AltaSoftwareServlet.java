 ...
 * @author Hp
 */
@WebServlet(name = "AltaSoftwareServlet", urlPatterns = {"/AltaSoftwareServlet"})
public class AltaSoftwareServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet AltaSoftwareServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet AltaSoftwareServlet at " + request.getContextPath() + "</h1>");
            iSoftwareDao xp = new SoftwareDaoSQL();
                ...
                Software exp = new Software(0, correo, software, Año, constancia);
                if(xp.altaSoftware(exp)){

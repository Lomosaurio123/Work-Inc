 ...
 * @author Hp
 */
@WebServlet(name = "ModificaSoftServlet", urlPatterns = {"/ModificaSoftServlet"})
public class ModificaSoftServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ModificaSoftServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ModificaSoftServlet at " + request.getContextPath() + "</h1>");
            iSoftwareDao xp = new SoftwareDaoSQL();
             int idsoft = Integer.parseInt(request.getParameter("idSoft"));
                ...
                Software exp = new Software(idsoft, correo, software, Año, constancia);
                if(xp.actualizaSoftware(exp)){

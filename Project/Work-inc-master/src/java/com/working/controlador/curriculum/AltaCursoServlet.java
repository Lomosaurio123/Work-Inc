...
public class AltaCursoServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet AltaCursoServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet AltaCursoServlet at " + request.getContextPath() + "</h1>");
            try{
                ...
                Cursos exp = new Cursos(0, correo, nomcurso, Ano, dura);
                if(xp.altaCursos(exp)){

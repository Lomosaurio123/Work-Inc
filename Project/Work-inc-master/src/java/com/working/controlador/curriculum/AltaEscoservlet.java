 ...
 * @author Hp
 */
@WebServlet(name = "AltaEscoservlet", urlPatterns = {"/AltaEscoservlet"})
public class AltaEscoservlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet AltaEscoservlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet AltaEscoservlet at " + request.getContextPath() + "</h1>");
             try{
                ...
                Escolaridad exp = new Escolaridad(0, correo, escuela, carrera, inicio, fin);
                if(xp.altaEscolaridad(exp)){

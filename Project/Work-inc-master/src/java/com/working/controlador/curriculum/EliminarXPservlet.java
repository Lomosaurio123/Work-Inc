 ...
 * @author Hp
 */
@WebServlet(name = "EliminarXPservlet", urlPatterns = {"/EliminarXPservlet"})
public class EliminarXPservlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet EliminarXPservlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet EliminarXPservlet at " + request.getContextPath() + "</h1>");
            iExperienciaDao xp = new ExperienciaDaoSQL();
            int idxp = Integer.parseInt(request.getParameter("idxp"));
                if(xp.borrarExperiencia(idxp)){

 ...
 * @author rodri
 */
@WebServlet(name = "ModificaXPservlet", urlPatterns = {"/ModificaXPservlet"})
public class ModificaXPservlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ModificaXPservlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ModificaXPservlet at " + request.getContextPath() + "</h1>");
            try{
                ...
                Experiencia exp = new Experiencia(idxp, correo, puesto, empresa, funcion, inicio, fin);
                if(xp.actualizaExperiencia(exp)){

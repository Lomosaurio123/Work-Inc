 ...
 * @author Hp
 */
@WebServlet(name = "EliminarSoftServlet", urlPatterns = {"/EliminarSoftServlet"})
public class EliminarSoftServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet EliminarSoftServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet EliminarSoftServlet at " + request.getContextPath() + "</h1>");
            iSoftwareDao xp = new SoftwareDaoSQL();
            int idsoft = Integer.parseInt(request.getParameter("idSoft"));
                if(xp.borrarSoftware(idsoft)){

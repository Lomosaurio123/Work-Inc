    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<h1>Servlet EliminarUsuario at " + request.getContextPath() + "</h1>");
                ...
                iUsuarioDao per = new UsuarioDaoSQL();
                if(per.borraUsuario(us.getCorreo(),us.getContra())){
                    sesion.invalidate();
                    response.sendRedirect("ConsultarNoticias");
                }else{
                    response.sendRedirect("ReadUsuario");
                }
